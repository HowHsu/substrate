...
LABEL io.parity.image.authors="devops-team@parity.io" \
	...
	io.parity.image.source="https://github.com/HowHsu/substrate/blob/${VCS_REF}/scripts/ci/docker/subkey.Dockerfile" \
	io.parity.image.revision="${VCS_REF}" \
	io.parity.image.created="${BUILD_DATE}" \
	io.parity.image.documentation="https://github.com/HowHsu/substrate/tree/${VCS_REF}/subkey"
