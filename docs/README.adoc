...
[source, shell]
----
git clone https://github.com/HowHsu/substrate.git
cd substrate
----
...
https://github.com/HowHsu/substrate/blob/master/core/primitives/src/crypto.rs#L767[here], but the
...
https://github.com/HowHsu/substrate/blob/master/LICENSE[LICENSE]
